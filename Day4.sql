...
SELECT NAME , MARKS FROM ENTRIES WHERE MARKS > ALL (	
SELECT MARKS FROM ENTRIES WHERE CITY = 'MUMBAI');		-- This subquery selects all STUDENTS MARKS FROM MUMBAI CITY.
-- The ALL operator ensures the MARKS in the outer query is higher than the marks of every student in MUMBAI CITY.
